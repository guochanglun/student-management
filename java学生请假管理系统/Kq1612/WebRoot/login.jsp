...
Object ok = request.getAttribute("ok");
Object rok = request.getAttribute("rok");
...
<style type="text/css">
body{ background:#0066A8 url(<%=path %>/img/login_bg.png) no-repeat center 0px;}
...
.login_user{ background: url(<%=path %>/img/input_icon_1.png) no-repeat 200px center; font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif}
.login_password{ background: url(<%=path %>/img/input_icon_2.png) no-repeat 200px center; font-family:"Courier New", Courier, monospace}
...
<body>
<div class="tit"><h3><font color="white">请假信息管理系统</font></h3></div>

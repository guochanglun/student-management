...
<ul class="breadcrumb">当前位置：
  学生管理
   ...
   <form id="submitForm" name="submitForm" action="<%=path %>/StuServlet?mode=add" method="post">
   
   <div style="width:900px; margin:auto">
   <table class="table table-bordered" >
     <tr>
       <td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">学号：</td>

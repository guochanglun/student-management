       ...
       <table class="table table-bordered">
        ...
        %>
         <tr>
		   ...
		   <td>
		   <a id="DataGrid1_ctl08_LinkButton1" href="<%=path %>/KqServlet?mode=sh1&id=<%=bean.getId() %>&states=1">通过</a>
		   <a id="DataGrid1_ctl08_LinkButton1" href="<%=path %>/KqServlet?mode=sh1&id=<%=bean.getId() %>&states=2">不通过</a>
		   </td>
         </tr>
         <%} %>
       </table>
